...
// FancyCounter component focuses only on UI rendering with a custom design.
// It receives the count, increment, and decrement logic through props.
const FancyCounter: React.FC<FancyCounterProps> = ({ count, increment, decrement }) => {
    return (
        <div className="flex flex-col gap-1">
            <label htmlFor="counterInput" className="pl-1 text-sm text-slate-700 dark:text-slate-300">Items(s)</label>
